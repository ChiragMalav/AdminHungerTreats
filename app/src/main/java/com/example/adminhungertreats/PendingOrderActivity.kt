...
import com.example.adminhungertreats.databinding.ActivityPendingOrderBinding
...
class PendingOrderActivity : AppCompatActivity(), PendingOrderAdapter.OnItemClicked {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Inititalization of database reference
    ...
    override fun onItemDispatchClickListener(position: Int) {
        ...
        val dispatchOrderReference = database.reference.child("CompletedOrder").child(dispatchItemPushKey!!)
        dispatchOrderReference.setValue(listOfOrderItem[position])
    ...
    private fun updateOrderAcceptStatus(position: Int) {
        //update order acceptance in user buy history and orderDetails
